      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div className="relative rounded-lg overflow-hidden bg-gradient-to-br from-purple-600 to-blue-700 flex flex-col items-center justify-center p-6 text-center h-full">
